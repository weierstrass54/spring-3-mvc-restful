...
public class PromoService extends ORMDatabaseService<Promo> {
    ...
    public List<Promo> loadBannerList()
        throws SQLException, InstantiationException, IllegalAccessException {
        return loadList(Promo.class, "SELECT * FROM public_api_v01.promo_get_banners()");
    }

    public List<Promo> loadArticleList(int offset, int limit)
        throws SQLException, InstantiationException, IllegalAccessException {
        return loadList(Promo.class, "SELECT * FROM public_api_v01.promo_get_articles( ?, ? )",
            offset, limit);
    }
